...
# Optional heavy dependencies (xgboost, catboost) are imported at runtime
# inside the trainer to avoid import-time failures when not installed.
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            # Try to include CatBoost if available
            try:
